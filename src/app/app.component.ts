  ...
  ngOnInit(): void {
    ...
    this.router.events.subscribe((event) => {
      if (event instanceof NavigationEnd) {
        ...
        this.isAuth = this.router.url === '/login' || this.router.url === '/register' || this.router.url === '/forgot-password' || this.router.url === '/email-verification' || this.router.url === '/reset-password' || this.router.url === '/index';
      }
    });
  }
}
